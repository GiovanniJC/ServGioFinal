...
$pdf->Cell(20,5, $row1['nombre'],1, 0, "C");
$pdf->Cell(20,5, $row1['Apaterno'],1, 0, "C");

$pdf->Cell(30,5, $row1['Amaterno'],1, 0, "C");
$pdf->Cell(20,5, $row1['curso'],1, 0, "C");
$pdf->Cell(30,5, $row1['fechaI'],1, 0, "C");
$pdf->Cell(20,5, $row1['fechaF'],1, 0, "C");
$pdf->Cell(30,5, $row1['division'],1, 1, "C");
